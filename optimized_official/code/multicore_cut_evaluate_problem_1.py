...
def evaluate_scene_a(graph_json, plan, bandwidth, capacity,
    ...
    def activate_task(task_id, now):
        ...
        active_remaining[task_id] = len(task['seq'])
    ...
    def retire(now):
        ...
        for task_id in list(core_active_task.values()):
            if task_id is None or active_remaining[task_id] != 0:
                continue
